...
const SkillSec = () => {
  ...
  return (
    <div className="bg-zinc-900 text-4xl sm:text-5xl md:text-7xl font-extrabold p-8 sm:p-8 md:p-20 leading-normal">
      ...
      <button className="text-2xl sm:text-2xl md:text-4xl border-2 px-3 sm:px-4 py-1 sm:py-2 mt-15 sm:mt-12 md:mt-20 rounded-md">
        development
      </button>
      ...
      <div className="mt-10 sm:mt-8 md:mt-10">
        <motion.div
          ref={ref}
          className="grid grid-cols-5 sm:grid-cols-6 md:grid-cols-5 lg:grid-cols-10 gap-5 sm:gap-6 md:gap-10"
        >
